...
async function startServer() {
  ...
  app.post("/api/generate-quiz", async (req, res) => {
    ...
    try {
      ...
      const textOutput = await callGeminiWithRetryAndFallback(ai, prompt, responseSchema);
  ...
  app.post("/api/format-custom-question", async (req, res) => {
    ...
    try {
      ...
      const textOutput = await callGeminiWithRetryAndFallback(ai, prompt, responseSchema, true);
