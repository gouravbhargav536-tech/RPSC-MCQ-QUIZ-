...
export default function DebugTerminal({ logs, onClose }: DebugTerminalProps) {
  ...
  return (
    <div className="fixed bottom-2 right-2 z-[9999] w-[95vw] md:w-[400px] max-h-[30vh] bg-slate-950 text-emerald-400 p-3 rounded-lg shadow-2xl font-mono text-[9px] overflow-y-auto border border-emerald-900/50 flex flex-col gap-1.5 pointer-events-auto">
